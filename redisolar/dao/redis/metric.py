...
class MetricDaoRedis(MetricDaoBase, RedisDaoBase):
    ...
    @staticmethod
    def _get_day_minute(date: datetime.datetime) -> int:
        """
    ...
    @staticmethod
    def _get_date_from_day_minute(date: datetime.datetime, day_minute: int) -> datetime.datetime:
    ...
    def insert(self, meter_reading: MeterReading, **kwargs) -> None:
        ...
        self.insert_metric(site_id=meter_reading.site_id, value=meter_reading.wh_generated,
                           unit=MetricUnit.WH_GENERATED, time=meter_reading.timestamp, pipeline=pipeline)
